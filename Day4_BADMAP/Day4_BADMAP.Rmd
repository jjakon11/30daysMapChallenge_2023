...
**Data source:** 
  * Taiwan county shape file: <https://data.gov.tw/dataset/17219>
...
Matsu<- ggplot()+
  geom_sf(data=Taiwan2 ,fill="#D8EFE5", colour="#183e4f")+
  coord_sf(xlim = c(119.7, 120.2), ylim = c(25.9, 26.4), expand = FALSE, crs=4326)+
  theme(panel.background = element_rect(fill = "#2f7a9a"), 
        panel.grid = element_blank(), 
        plot.margin = margin(-0.8, 0, 0, 0, "cm"),
        plot.background = element_rect(fill = "#2f7a9a", colour = "#2f7a9a"),  
...
Lambai <- ggplot()+
  ...
  theme(panel.background = element_rect(fill = "#2f7a9a"), 
        ...
        axis.title.y = element_blank(), 
        plot.title = element_text(vjust = -14, hjust = 0.5, color="#e4f4ed", size=18))+
  ggtitle("Ryukyu Island")

Diaoyutai <- ggplot()+
  geom_sf(data=TaiwanVg_bind ,fill="#D8EFE5", colour=NA)+
...
#--output--
ggexport(Island_title, filename = "Island map.png", width =16800, height =9150, res =900 )
