...
Asia_noom <- ggplot()+
  ...
  scale_size_manual(name ="Species", 
                     ...
                     labels = c(expression(italic("Mitrastemon yamamotoi")),
...
SpDis2 <- annotate_figure(SpDis, top = text_grob(expression(paste("Distribution of ", italic( "Mitrastemon yamamotoi") ," and its variants")),color = "#2f7a9a",face = "bold",size = 20), 
